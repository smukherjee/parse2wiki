...
**Scope:** multi-sensor correlation, suppression monitoring, evacuation modelling. Register AI-14 clarifies this is **advisory analytics layered over, never replacing, the certified fire system**. [GROUNDED: CR/BRD §3.5.3; register AI-14; Consolidated FINAL] We preserve this "advisory, never replacing" framing throughout.
...
Our RGIA proof point — 40+ integrated systems, 100+ KPIs tracked, 18+ months live operation — is the strongest available evidence that a federated, governed AI-agent layer of this scope has been operated at airport scale. [GROUNDED: RGIA case study] We commit to the BRD's platform-wide predictive accuracy KPI (≥ 80% precision / ≥ 75% recall, BRD §2.3 KPI-4) as the floor for the agent layer as a whole. [GROUNDED: CR/BRD §2.3 KPI-4, cross-confirmed by register AI-05]
